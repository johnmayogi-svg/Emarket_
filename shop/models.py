...
class Product(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2, default=0)  # Added default
...
class OrderItem(models.Model):
    ...
    def get_total(self):
        """Return subtotal for this item (handles missing values safely)."""
        price = self.price or (self.product.price if self.product else 0)
        quantity = self.quantity or 0
        return price * quantity  # Safe multiplication
